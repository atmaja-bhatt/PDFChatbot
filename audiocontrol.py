...
def stop_speaking():
    ...
    if hasattr(st.session_state.engine, '_inLoop') and st.session_state.engine._inLoop:
...
def user_input(user_question):
    # Only generate new response if question has changed
    if user_question != st.session_state.last_question:
        st.session_state.current_response = generate_response(user_question)
